...
window._formatDate = function () {
  var val = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Date();
  var format = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'year-month-date';
  ...
  if (format.includes('monthName')) res = res.replace('monthName', months[val.getMonth()]);else if (format.includes('month')) res = res.replace('month', this._stringifyNumber(parseInt(val.getMonth()) + 1));
